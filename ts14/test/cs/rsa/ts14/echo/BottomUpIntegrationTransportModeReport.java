...
public class BottomUpIntegrationTransportModeReport {
	...
	public void setup() {
		 ...
		 *  - Hotel report builder implementation.
		 */
		processor = new StandardTimesagLineProcessor(
			new implLineTypeClassifierStrategy(), 
			new TransportModeOverviewBuilder(), 
			new InitialState());
	}
	
	@Test
	public void testTransportationModeOverviewReportGeneration() {
		...
		System.out.println("");
		System.out.println("---   Transportation mode overview report - begin  ---");
		System.out.println("");
		System.out.println(processor.getReport());
		System.out.println("");
		System.out.println("---   Transportation mode overview report - end  ---");
		System.out.println("");
	}
}
